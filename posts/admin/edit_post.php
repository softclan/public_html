...
require_once('../../private/validate_posts.php');
  ...
  if($post_id) {
    ...
    $category = $_POST['post_category'];
     ...
     //log_input($title, $visible,$content, $first_tag, $second_tag, $third_tag, $post_id, $category );
    ...
    $result = update_post($post_id, $title, $title_slug, $visible,$content, $first_tag, $second_tag,
    $third_tag, $category );
        ...
        <div class="page-content--bgf7">
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Edit Post</li>
                                    </ul>
                                </div>
            ...
            <section class="welcome p-t-10">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-4">Edit
                                <span>Post</span>
                            </h1>
                            <hr class="line-seprate">
                            <div class="container-contact100">

                                <form method="post" action="<?php echo url_for('admin/edit_post.php'); ?>" >
                                    <div class="form-row">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <span class="status--denied"><?php echo isset($errors['category']) ?$errors['category'] : '' ?></span>
                                      </div>
