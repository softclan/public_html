...
require_once('./private/initialize.php');
  ...
  $post_id = str_replace("public/", "", $post_id);
  if($post_id) {  
    $post = find_post_by_slug($post_id);
  } else {
...
this.page.url = "<?php echo "https://oprextra.com/public/" .$post['TitleSlug'] ?>"; // Replace PAGE_URL with your page's canonical URL variable
